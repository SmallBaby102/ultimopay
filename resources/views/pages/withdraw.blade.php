            ...
            <div class="row crypto_content p-2">
              ...
              <div class="withdraw_content">
                 @if($tfaStatus !== "enabled")
                  ...
                  <input type="text" class="address_input " id="code" placeholder="ENTERE 2-FA code(for https://dashboard.ultimopay.io)" />
                  <div class="content_title mt-2">Password</div>
                  <input type="text" class="address_input " id="password" placeholder="ENTERE Login Password" />
              
                  <div class="mt-2 text-center">
                    @if($tfaStatus !== "enabled")
                      <button class="btn content_btn" id="withdraw" disabled >WITHDRAW</button>
                    @else
